...
// regex: Votre empreinte carbone\*\* \*\*annuelle\*\* \*\*estim=C3=A9e\*=\r\n\* est de : \*\*[0-9,]+
template tonnesRegex(msg_bytes) {
	...
	for (var i = 0; i < num_bytes; i++) {
		...
		multi_or[0][i].in[0] <== eq[26][i].out;
		multi_or[0][i].in[1] <== eq[27][i].out;
		multi_or[0][i].in[2] <== eq[28][i].out;
		multi_or[0][i].in[3] <== eq[29][i].out;
		multi_or[0][i].in[4] <== eq[19][i].out;
		multi_or[0][i].in[5] <== eq[30][i].out;
		multi_or[0][i].in[6] <== eq[31][i].out;
		multi_or[0][i].in[7] <== eq[32][i].out;
		multi_or[0][i].in[8] <== eq[33][i].out;
		multi_or[0][i].in[9] <== eq[34][i].out;
		multi_or[0][i].in[10] <== eq[21][i].out;
		and[70][i].b <== multi_or[0][i].out;
		and[71][i] = AND();
		and[71][i].a <== states[i][71];
		and[71][i].b <== multi_or[0][i].out;
